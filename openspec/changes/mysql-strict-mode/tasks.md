...
- [ ] 2.3 CI 验证：确认 GitHub Actions 编译通过（CI 已安装 libmysqlclient-dev）

## 3. 文档更新

- [ ] 3.1 更新 README.md，说明 MySQL 配置要求和本地开发环境设置
- [ ] 3.2 提交变更，使用规范提交格式 `🔧 fix: 移除 MySQL 降级逻辑，启用严格失败模式`

## 4. 归档

- [ ] 4.1 运行 openspec archive 验证实现与 specs 一致
- [ ] 4.2 推送变更到远程仓库