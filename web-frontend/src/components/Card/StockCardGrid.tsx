  ...
  if (records.length === 0) {
    return (
      <div className="bg-surface rounded-xl p-12 text-center border border-border-default">
        <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-elevated flex items-center justify-center">
          <svg className="w-8 h-8 text-text-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
        </div>
        <p className="text-text-secondary text-sm">暂无分析记录</p>
        <p className="text-text-tertiary text-xs mt-1">调整筛选条件或等待分析完成</p>
      </div>
    )
  }
