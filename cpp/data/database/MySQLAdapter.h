#ifndef DATA_DATABASE_MYSQL_ADAPTER_H
#define DATA_DATABASE_MYSQL_ADAPTER_H
...
private:
    ...
    std::string generateCreateIndexSQL(const IndexDefinition& index);
    
    std::unique_ptr<sqlpp::mysql::connection> connection_;
...
#endif // DATA_DATABASE_MYSQL_ADAPTER_H